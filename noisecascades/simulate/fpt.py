...
from noisecascades.simulate.step import semi_impl_euler_maruyama_coupled_doublewell_alphastable_step, euler_step

@jit(nopython = True)
def simulate_fpt_orthant_logdt(N, x, t, dt, dtao, c, A, L, boundary = 0.0, method = "semi_impl"):
...
@jit(nopython = True)
def simulate_fpt_orthant(N, x, t, dt, dtao, c, A, L, boundary = 0.0, method = "semi_impl"):
